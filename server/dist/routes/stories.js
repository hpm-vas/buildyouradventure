...
exports.createStoryRoutes = createStoryRoutes;
const express_1 = require("express");
function createStoryRoutes(storage) {
    ...
    router.get('/:storyId/nodes', async (req, res) => {
        try {
    ...
    router.get('/:storyId/nodes/start', async (req, res) => {
        try {
    ...
    router.get('/:storyId/nodes/by-key/:nodeKey', async (req, res) => {
        try {
    ...
    router.post('/:storyId/nodes', async (req, res) => {
        try {
            if (!req.body.nodeKey) {
    ...
    router.get('/:storyId/choices', async (req, res) => {
        try {
    ...
    router.get('/:storyId/events/last', async (req, res) => {
        try {
    ...
    router.post('/:storyId/events', async (req, res) => {
        try {
            if (!req.body.nodeKey) {
                return res.status(400).json({ error: 'Node key is required' });
            }
    ...
    router.delete('/:storyId/events', async (req, res) => {
        try {
